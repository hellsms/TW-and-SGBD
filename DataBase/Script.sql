...
product_type_code NUMBER(9) PRIMARY KEY,

parent_product_type_code NUMBER(9) REFERENCES Ref_Product_Types(product_type_code),
...
product_type_code NUMBER(9) REFERENCES Ref_product_Types (product_type_code),

ret_merchandise_auth_nr NUMBER(9) NOT NULL,
...
payment_method_code NUMBER(9) PRIMARY KEY,
...
customer_payment_id NUMBER(9) PRIMARY KEY,

customer_id NUMBER(9) REFERENCES Customers (customer_id),

payment_method_code NUMBER(9) REFERENCES Ref_Payment_Methods (payment_method_code),
...
order_status_code NUMBER(9) PRIMARY KEY,
...
order_item_id NUMBER(9) NOT NULL,
...
invoice_status_code NUMBER(9) PRIMARY KEY,
...
order_item_status_code NUMBER(9) PRIMARY KEY,
...
order_status_code NUMBER(9) REFERENCES Ref_Order_Status_Codes (order_status_code),
...
invoice_number NUMBER(9) PRIMARY KEY,

order_id NUMBER(9) REFERENCES Orders (order_id),

invoice_status_code NUMBER(9) REFERENCES Ref_Invoice_Status_Codes (invoice_status_code),
...
invoice_number NUMBER(9) REFERENCES Invoices (invoice_number),
...
order_item_id NUMBER(9) PRIMARY KEY,

product_id NUMBER(9) REFERENCES Products (product_id),

order_id NUMBER(9) REFERENCES Orders (order_id),

order_item_status_code NUMBER(9) REFERENCES Ref_Order_Status_Codes (order_status_code),

order_item_quantity NUMBER(3) NOT NULL,
...
shipment_id NUMBER(9) PRIMARY KEY,
