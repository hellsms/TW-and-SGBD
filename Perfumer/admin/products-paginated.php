...
<?php
	...
	for ($i = $start; $i < $end; $i++)
	{
		...
		echo '<td><a href="edit-products.php?id=' . mysqli_result($result, $i, 'prod_id') . '"><img src="../images/update.ico" alt="update" height="20" width="20"></a></td>';
		echo '<td><a href="delete-products.php?id=' . mysqli_result($result, $i, 'prod_id') . '"><img src="../images/remove.ico" alt="remove" height="20" width="20"></a></td>';
		echo "</tr>"; 
	}
	echo "</table>"; 
	
?>
<p><a href="new-product.php"><img src="../images/add.ico" alt="update" height="20" width="20"> Add a new category</a></p>
