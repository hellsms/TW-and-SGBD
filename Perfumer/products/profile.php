...
<body>
    <div id="wrapper">
        ...
        <div id="navigation">
            <ul>
		<li><a href="index.php" title="css menus" ><span>Home</span></a></li>
		<li><a href="aboutUs.html" title="css menus"><span>About Us</span></a></li>
		<li><a href="#" title="css menus"><span>Services</span></a></li>
		<li><a href="log-in.php" title="css menus" ><span>Login</span></a></li>
...
<?php
	...
	for ($i = $start; $i < $end; $i++)
	{
		...
		echo "<td><a href=../add_perfume.php?id=".$result[0]."><img src='../images/add.ico' width=20 height=20></a></td>";
		echo "</tr>"; 
	}
	echo "</table>"; 
	echo "<p><a href=../logout1><img src='../images/remove.ico' width=20 height=20>Logout</a></p>";
